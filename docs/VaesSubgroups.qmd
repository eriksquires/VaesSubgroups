...
While these patterns are striking, our analysis is a secondary exploration. We summarized the original Vaes patient data by symptom domains. This together with the small subgroup sizes (8 and 5 clusters) and the original clustering methods may have distorted some relationships. Patterns in the plots may also suggest trends that do not truly exist or cannot be translated to individual patients or symptoms.
