...
In the following sections we will start by showing how the groups are most similar, then how they differ. We add an "all" category to gauge overall symptom severity to the original symptom domains.
...
**Groupings:** From visual inspection of the charts above we group clusters `r high_intensity` as high intensity, `r low_intensity` as low intensity. We'll keep these groupings for all plots that follow.
