...
#
# Honestly hrbrthemes::theme_ipsum can be difficult to get working in some 
# environments. Much easier to switch ggplot to use theme_minimal() instead.
#
library(hrbrthemes)
library(extrafont)
...
#   scale_shape_manual(values = c("high" = 16, "low" = 17, "out" = 4)) +
    ...
    labs(title = paste(ylabel, "vs PEM"),
         x = "PEM",
         y = ylabel) +
    theme_ipsum(base_family = "Arial") +  # Or switch to theme_minimal()
