...
::: {#tbl-t3 tbl-cap="Leave-one-out Analysis" tbl-pos="h"}
...
We can also quantify the significance of the group distinction using analysis of covariance (ANCOVA) to identify the domains which are most discriminatory. We compare our two groups for each symptom domain. 

\FloatBarrier

::: {#tbl-t4 tbl-cap="ANCOVA Analysis" tbl-pos="h"}
...
**Statistical Summary**
These three analyses strongly support the existence of two distinct subgroups within the Vaes clusters while the ANCOVA results also helps identify which domains can best identify the two subgroups.
