...
analysis of covariance (ANCOVA). We compare our two groups for each
symptom domain.
...
\toprule
Domain & F Value & P Value & significance \\ 
\midrule\addlinespace[2.5pt]
other & 33.3 & < 0.001 & *** \\ 
...
between the two groups. The high F and P values for fatigue, however, do
not agree with the charts. As we note earlier in
...
group. The high F and P values in the ANCOVA analysis for fatigue is
most likely an artifact of the high spread in the low-intensity group.

\textbf{Statistical Summary} These three analyses strongly support the
existence of two distinct subgroups within the Vaes clusters.
