...
recognized in prior work. This subgroup has characteristics that
resemble fibromyalgia, which we'll cover in-depth, below.
...
Our secondary analysis shows that the 13 clusters identified by Vaes can
be organized into two broader structures defined by overall symptom
...
We analysis of covariance (ANCOVA) to identify the domains which are
most statistically significant and discriminatory. We compare our two
