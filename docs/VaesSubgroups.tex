...
provides one of the first opportunities to quantitatively describe
fibromyalgia-like patients inside ME/CFS from a single, uniformly
collected cohort.
...
discriminatory. We compare our two groups for each symptom domain. We
arrange the results by descending F-statistic and show the p-value
