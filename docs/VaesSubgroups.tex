...
has selective amplification: pain and neurocognitive symptoms escalated
more rapidly with PEM, while immune and sleep symptoms remained
relatively flat. This subgroup's profile appears to resemble that of
fibromyalgia.
...
inspection, we provide more statistical analysis in
...
dataset. In those charts, pain and neurocognitive symptoms trend upward
and then the clusters stop at C7 just before they would cross the
high-intensity group trend lines. This truncation could be due to
diagnostic criteria that would classify these individuals as
fibromyalgia when pain and neurocognitive scores are above the
...
\addcontentsline{toc}{subsection}{Appendix B: Statistical Analysis}
